...
interface TanstackHeavyProps {}

export const TanstackHeavy: FC<TanstackHeavyProps> = () => {
  ...
  const { getTotalSize, getVirtualItems, isScrolling } = useVirtualizer({
    ...
    estimateSize: () => VIRTUALIZED_HEAVY_ROW_HEIGHT,
    overscan: OVERSCAN_COUNT,
  });

  return (
    <MountProfiler
      profilerId="tanstack-virtual--heavy"
